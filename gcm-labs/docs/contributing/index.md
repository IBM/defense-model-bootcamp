...
This guide explains how to add or update content in the GCM Lab Guides.
...
Push directly to `main`. GitHub Actions will build the site and deploy it to GitHub Pages automatically. If the build fails (e.g. a broken link), the live site is **not** updated.

Check the [Actions tab](https://github.com/IBM/gcm-bootcamp/actions) to confirm deployment status after pushing.
