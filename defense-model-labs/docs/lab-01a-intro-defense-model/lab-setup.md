...
- Access to the ARGUS AI web interface (URL provided by instructor)
- The sample AAR document: [`AAR_OperationGhostFalcon.docx`](/AAR_OperationGhostFalcon.docx)
...
2. Open your web browser and navigate to the ARGUS AI interface [http://169.47.36.48:32044/](http://169.47.36.48:32044/)
...
![Close Sales Opportunity](/img/lab-01/close-sales-opportunity.png)
5. Verify you can see the chat interface and document upload area
![ARGUS AI home screen](/img/lab-01/argus-home-screen.png)

---

Once you have completed the setup steps above, you're ready to begin [Step 1: Upload AAR](./step-01-upload-aar.md).